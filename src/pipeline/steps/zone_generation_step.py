...
class ZoneGenerationStep(BaseStep):
    ...
    def _generate_osm_zones(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Generated and saved {num_zones} intelligent zones to {CONFIG.zones_file}")
    ...
    def _generate_synthetic_zones(self) -> None:
        ...
        self.logger.info("Generating synthetic network zones using traditional method...")
        ...
        self.logger.info(f"Extracted land use zones successfully using traditional method with {self.args.land_use_block_size_m}m blocks")
