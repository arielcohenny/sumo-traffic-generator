...
- **TestGlobalConfig** (4 methods):
  ...
  - `test_vehicle_types_configuration()`: Validates vehicle type definitions (passenger, public)
...
- **TestSyntheticGridScenarios** (3 methods):
  ...
  - `test_multi_modal_traffic_mix()`: Vehicle types (50% passenger, 50% public), routing strategies
...
- **TestTrafficGeneration** (2 methods):
  ...
  - `test_vehicle_route_generation()`: Steps 4-6 validation - 20 vehicles, passenger types
...
- **Vehicle Types**: passenger, public distribution
