...
class TestTrafficControlPerformance:
    ...
    def test_tree_method_vs_baseline_performance(self):
        ...
        if actuated_travel_time > 0:
            tree_vs_actuated_improvement = (
                actuated_travel_time - tree_method_travel_time) / actuated_travel_time

        tree_vs_fixed_improvement = 0.0
        if fixed_travel_time > 0:
            tree_vs_fixed_improvement = (
                fixed_travel_time - tree_method_travel_time) / fixed_travel_time
        ...
        print(
            f"Tree Method vs Actuated improvement: {tree_vs_actuated_improvement:.1%}")
        print(
            f"Tree Method vs Fixed improvement: {tree_vs_fixed_improvement:.1%}")
