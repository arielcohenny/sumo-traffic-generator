...
class TestPerformanceBaselines:
    ...
    def test_3x3_grid_performance_baseline(self, temp_workspace):
    ...
    @pytest.mark.scenario  
    def test_5x5_grid_performance_baseline(self, temp_workspace):
...
class TestTrafficControlPerformance:
    ...
    def test_traffic_control_performance(self, temp_workspace, control_method):
        ...
        perf_file = temp_workspace / f"performance_{control_method}.json"
        with open(perf_file, 'w') as f:
            json.dump(perf_data, f, indent=2)

    @pytest.mark.scenario
    def test_tree_method_vs_baseline_performance(self, temp_workspace):
        ...
        for method in ["tree_method", "actuated", "fixed"]:
            ...
            start_time = time.time()
            result = run_cli_command(args, workspace=temp_workspace)
            execution_time = time.time() - start_time
        ...
        # Tree Method should perform better (lower travel times)
        ...
        results_file = temp_workspace / "performance_comparison.json"
...
class TestScalabilityPerformance:
    ...
    def test_network_size_scaling(self, temp_workspace, grid_size):
        ...
        scaling_file = temp_workspace / f"scaling_grid_{grid_size}.json"
        with open(scaling_file, 'w') as f:
            json.dump(scaling_data, f, indent=2)

    @pytest.mark.slow
    @pytest.mark.parametrize("vehicle_count", [100, 200, 400])
    def test_vehicle_count_scaling(self, temp_workspace, vehicle_count):
...
class TestMemoryPerformance:
    ...
    @pytest.mark.scenario
    def test_memory_efficiency(self, temp_workspace):
    ...
    @pytest.mark.scenario
    def test_tree_method_sample_performance(self, temp_workspace, sample_networks_path):
