...
# Synthetic Grid Experiment Run 82
...
echo "🔄 Starting experiment run 82 (light load)"
...
try:
    ...
    with open('evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/tree_method/simulation.log', 'w') as f:
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/tree_method/simulation.log" ]; then
        echo "   Last 3 lines of log:"
        tail -n 3 "evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/tree_method/simulation.log"
    fi
fi
...
try:
    ...
    # Write output to log file
    with open('evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/actuated/simulation.log', 'w') as f:
        f.write(result.stdout)
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/actuated/simulation.log" ]; then
        echo "   Last 3 lines of log:"
        tail -n 3 "evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/actuated/simulation.log"
    fi
fi
...
try:
    ...
    # Write output to log file
    with open('evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/fixed/simulation.log', 'w') as f:
        f.write(result.stdout)
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/fixed/simulation.log" ]; then
        echo "   Last 3 lines of log:"
        tail -n 3 "evaluation/benchmarks/synthetic-grids/grids-5x5/82/results/fixed/simulation.log"
    fi
fi

echo "🏁 Experiment run 82 completed"
