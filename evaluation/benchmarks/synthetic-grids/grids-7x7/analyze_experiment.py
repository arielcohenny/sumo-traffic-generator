...
"""
Experiment-Level Analysis for Synthetic Grid 7x7
...
def analyze_experiment():
    ...
    grid_config = config['grid_configurations']['7x7']
    ...
    print(f"\nSUMMARY STATISTICS (7x7 Grid - {grid_config['dimension']}x{grid_config['dimension']}):")
    print("=" * 70)
    ...
    print(f"\nMETHOD PERFORMANCE COMPARISON (7x7 Grid):")
    print("=" * 50)
    ...
    if 'tree_method' in summary_stats:
        print(f"\nTREE METHOD VALIDATION (7x7 Grid):")
        print("=" * 40)
