...
"""
Grid-Specific Experiment Runner for 9x9 Synthetic Grid
...
--seed $SEED \\
> "evaluation/benchmarks/synthetic-grids/grids-9x9/{experiment['run_id']}/results/{method}/simulation.log" 2>&1
...
def create_analyze_results_script(run_dir, experiment):
    ...
    if template_path.exists():
        ...
        adapted_content = template_content.replace(
            ...
            'Experiment1-realistic-high-load', f'grids-9x9'
        )
...
def main():
    ...
    print("SYNTHETIC GRID EXPERIMENT RUNNER - 9x9 GRID")
    print("=" * 80)
    ...
    print(f"\\n{'=' * 80}")
    print("🏁 9x9 GRID EXPERIMENTS COMPLETE")
    print(f"{'=' * 80}")
